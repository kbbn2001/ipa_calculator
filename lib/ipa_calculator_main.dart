                            ...
                            builder: ((context) {
                              if (_resultInputAmount!.text.isEmpty ||
                                ...
                                return AlertDialog(
                                  ...
                                  content:
                                      Text("전체 수치는 필수값입니다. 모든 값을 입력해주세요."),
                                  actions: <Widget>[
                                    Container(
                                ...
                                return AlertDialog(
                                  ...
                                  actions: <Widget>[
                                    Container(
                                      child: ElevatedButton(
                                        onPressed: () {
                                          final _favoriteModel =
                                              SqliteFavoriteModel();
                                          _favoriteModel.InsertFavorite(IPAFavorite(
                                              resultInputAmount: double.parse(
                                                  _resultInputAmount!.text),
                                              resultMoisture: double.parse(
                                                  _resultMoisture!.text),
                                              returnInputAmount: double.parse(
                                                  _returnInputAmount!.text),
                                              returnMoisture: double.parse(
                                                  _returnMoisture!.text),
                                              purifyInputIPA: double.parse(
                                                  _purifyInputIPA!.text),
                                              purifyInputWater: double.parse(
                                                  _purifyInputWater!.text),
                                              purifyTemperature: double.parse(
                                                  _purifyTemperature!.text),
                                              purifyMoisture: double.parse(
                                                  _purifyMoisture!.text),
